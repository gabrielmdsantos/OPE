    ...
    <fieldset id="form-pj">
        <table id="tab12">
            <tr>
                ...
                <td>                
                &nbsp; CNPJ:<input type="text"  name="cpf"  value=""  id="cCC" size="14" maxlength="14" placeholder="000.000.000-00" /> 
                </td>
                <td>
            ...
            <tr>
                <td>
                    <p>&nbsp; IE: <input type="text"     value="" name="rg" id="cRG" size="10" maxlength="10" placeholder="00.000.000-0" />
                </td>
                <td>
