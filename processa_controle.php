       ...
       // $rec->execute();
        ...
        array_map (function($rec,$des){
            ...
            <tr>
                ...
                <td><div class='editar'><a href='lancamentos.php?acao=edit&func=";echo ($rec['ID_CONTRATO']); echo"' title='Editar dados'> <img src='img/ico-moeda.png' width='16' height='16' alt='Editar'> </a></div>  </td>
            </tr>
            ";
        }, $rec,$des);
